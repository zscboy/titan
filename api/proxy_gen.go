...
type SchedulerStruct struct {
	...
	Internal struct {
		...
		SetNodeCountLimit func(p0 context.Context, p1 int) error `perm:"web,admin"`
...
func (s *SchedulerStruct) SetNodeCountLimit(p0 context.Context, p1 int) error {
	if s.Internal.SetNodeCountLimit == nil {
		return ErrNotSupported
	}
	return s.Internal.SetNodeCountLimit(p0, p1)
}

func (s *SchedulerStub) SetNodeCountLimit(p0 context.Context, p1 int) error {
	return ErrNotSupported
}
...
var (
	_ Asset      = new(AssetStruct)
	_ AssetAPI   = new(AssetAPIStruct)
	_ Candidate  = new(CandidateStruct)
	_ Common     = new(CommonStruct)
	_ DataSync   = new(DataSyncStruct)
	_ Device     = new(DeviceStruct)
	_ Edge       = new(EdgeStruct)
	_ L5         = new(L5Struct)
	_ Locator    = new(LocatorStruct)
	_ NodeAPI    = new(NodeAPIStruct)
	_ ProjectAPI = new(ProjectAPIStruct)
	_ Scheduler  = new(SchedulerStruct)
	_ Validation = new(ValidationStruct)
	_ Workerd    = new(WorkerdStruct)
)
